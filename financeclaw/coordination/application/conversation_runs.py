"""会话 Turn 的运行协调：提交、观察、交互恢复、委派推进与终态落盘。"""
...
from financeclaw.coordination.application.streaming import (
    final_assistant_content as _final_assistant_content,
)
from financeclaw.coordination.backends.ports.agent_server import AgentServerClient
from financeclaw.coordination.delegation.repository import DelegationConflict
...
from financeclaw.kernel.delegation.models import DelegationRecord, DelegationStatus
...
class ConversationRunService:
    """管理会话 Turn 的执行生命周期：提交、状态同步、委派推进、恢复与取消。"""
