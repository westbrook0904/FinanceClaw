"""Live Stage-4 BFF-to-Agent-Server workflow interrupt/resume smoke."""
...
from financeclaw.workflows import SqlAlchemyWorkflowRepository
...
async def probe_workflow(
    *,
    ...
    try:
        ...
        # Rebuild the repository boundary to prove that status and version pins
        # come from business persistence rather than process-local dictionaries.
