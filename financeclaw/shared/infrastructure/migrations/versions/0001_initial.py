"""未上线应用的统一初始业务 schema，操作回执与渠道交互均复用已有实体。"""
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("backend_instance_id", sa.String(length=128), nullable=True),
...
def downgrade():
    ...
    op.drop_index("uq_operation_backend_identity", table_name="run_operations")
