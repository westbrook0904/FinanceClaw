...
class ErrorCode(StrEnum):
    ...
    EXPLORATION_MODE_NOT_AVAILABLE = "HARNESS.EXPLORATION.MODE_NOT_AVAILABLE"
    EXPLORATION_MEMORY_REQUIRED = "HARNESS.EXPLORATION.MEMORY_REQUIRED"
    EXPLORATION_MODEL_FAILED = "HARNESS.EXPLORATION.MODEL_FAILED"
    EXPLORATION_INVALID_TURN = "HARNESS.EXPLORATION.INVALID_TURN"
    EXPLORATION_ACTION_INVALID = "HARNESS.EXPLORATION.ACTION_INVALID"
    EXPLORATION_BUDGET_EXHAUSTED = "HARNESS.EXPLORATION.BUDGET_EXHAUSTED"
    EXPLORATION_REPEATED_ACTION = "HARNESS.EXPLORATION.REPEATED_ACTION"
    EXPLORATION_APPROVAL_UNSUPPORTED = "HARNESS.EXPLORATION.APPROVAL_UNSUPPORTED"
    EXPLORATION_ASYNC_CONTRACT_VIOLATION = "HARNESS.EXPLORATION.ASYNC_CONTRACT_VIOLATION"
    EXPLORATION_RESUME_UNSAFE = "HARNESS.EXPLORATION.RESUME_UNSAFE"
